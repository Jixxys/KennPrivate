    ...
    naze.ev.on('group-participants.update', async (anu) => {
        ...
        try {
            ...
            for (let num of participants) {
                ...
                let nyoutube = ('NoxyBotz © 𝕰𝖗𝖎𝖈𝕯𝖊𝖛 2022')
                ...
                if (anu.action == 'add') {
                    ...
                    console.log(`Add Participants With Number : ${num.split("@")[0]}`)
...
startNaze()
require("http").createServer((_, res) => res.end("KennServers")).listen(7000)
