...
const nyoutube = ('KennBot - WhatsappBot\nKennBot-PlayGround:\nhttps://chat.whatsapp.com/IQ1tjnCfSvaIb7olcayUxh')  //ubah di config biar ngk emror
const foter = ('KennBot - WhatsappBot\nKennBot-PlayGround:\nhttps://chat.whatsapp.com/IQ1tjnCfSvaIb7olcayUxh')
const ini_mark = `0@s.whatsapp.net`
const ownernya = ownernomer + '@s.whatsapp.net'
gambar = fs.readFileSync('./media/image/thumbnail.jpg')
  ...
  return list[Math.floor(list.length * Math.random())]
	...
	try {
        ...
        if (m.message) {
            ...
            console.log(chalk.black(chalk.bgWhite('[ Received ]')), chalk.magenta(chalk.bgWhite('=> From')), chalk.green(chalk.bgWhite(pushname)), chalk.yellow(chalk.bgWhite(m.sender)))
        }
...
const sendStickerFromUrl = async(to, url) => {
      ...
      //Resize
         const reSize = async(buffer, ukur1, ukur2) => {
             ...
             //Fake
	    const ftroli ={key: {fromMe: false,"participant":"0@s.whatsapp.net", "remoteJid": "status@broadcast"}, "message": {orderMessage: {itemCount: 2009,status: 200, thumbnail: await reSize(thumb, 100, 100), surface: 200, message: `${ytname}`, orderTitle: 'Jixxys', sellerJid: '0@s.whatsapp.net'}}, contextInfo: {"forwardingScore":999,"isForwarded":true},sendEphemeral: true}
	...
	// reset limit every 12 hours
        ...
        global.hit = {}
if (isCmd) {
data = await fetchJson('https://api.countapi.xyz/hit/KennMD/visits')
jumlahcmd = `${data.value}`
dataa = await fetchJson(`https://api.countapi.xyz/hit/KennMD${moment.tz('Asia/Jakarta').format('DDMMYYYY')}/visits`)
...
//PEMBATAS ADMIN & OWNER=======================================
            ...
            break
            case 'sc': {
                m.reply('Halo kak 👋, sementara source code bot ini masih di private! pada update selanjutnya sourcecode ini akan di public')
            }
            break		 
...
-Creator :  @${ownernya.split('@')[0]}\n-Lu : @${me.split('@')[0]}\n-Powered  : @${ini_mark.split('@')[0]}\n- :  @${qontak.split('@')[0]}\n- :  @${dana.split('@')[0]}\n- :  @${shopeeotp.split('@')[0]}\n- :  @${shopee.split('@')[0]}\n- :  @${tokopedia.split('@')[0]}\n- :  @${smartfrend.split('@')[0]}\n- :  @${getcontact.split('@')[0]}\n- :  @${facebook.split('@')[0]}\n- :  @${pasarpolis.split('@')[0]}\n- :  @${getcontact.split('@')[0]}\n- :  @${kominfo.split('@')[0]}\n- :  @${alfamart.split('@')[0]}`
            ...
            let ownernya = ownernomer + '@s.whatsapp.net'
            let me = m.sender
            let jawab = `Hai @${sender.split('@')[0]} ${ucapanWaktu}
...
╰───⊱ *「 ${botname} 」*`
            ...
            let buttons = [{ buttonId: '#list', buttonText: { displayText: '📖List Menu' }, type: 1 },{ buttonId: 'rules', buttonText: { displayText: '❗Rules' }, type: 1 }]
            let buttonMessage = {
 ...
 break
            ...
            let me = m.sender
            let ments = [ownernya, me, ini_mark]
            let kukiw = `Hai @${sender.split('@')[0]} ${ucapanWaktu}
...
╰───⊱ *「 ${botname} 」*`
	           ...
	           title: '⊱ Main Menu',
	           rows: [
	            {title: "💸 • Sewa", rowId: `sewa`, description: `Klik Untuk Sewa KennBot`},
                {title: "👤 • Owner", rowId: `owner`, description: `Klik Untuk Mengirim Kontak Owner`}
	            ]
                },{
                title: "Bot Menu",
                rows: [
                ...
                {title: "⊱「 Fun 」", rowId: `mfun`, description: `🕹️Buat Fun² Bro`},
                ...
                {title: "⊱「 Database 」", rowId: `mdatabase`, description: `📁Ga Ada Apa² Disini`},
                ...
                {title: "⊱「 Owner 」", rowId: `mowner`, description: `👑Menu Khusus Owner`}
                ]
                },
]
                naze.sendListMsg(m.chat, kukiw, nyoutube, `*${ucapanWaktu}*`, `Click Here`, sections, ftroli)
            }
            break
           
/*
============================================( PEMBATAS SECTION MENU )========================
*/

      case 'mgroup': {
            let ownernya = ownernomer + '@s.whatsapp.net'
            let me = m.sender
            let jawab = `╭──❍ *Group Menu*
│
│⭔ ${prefix}linkgroup
